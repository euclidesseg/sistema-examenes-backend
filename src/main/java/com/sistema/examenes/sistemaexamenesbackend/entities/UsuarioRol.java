...
public class UsuarioRol {
    ...
    @ManyToOne(fetch = FetchType.EAGER)  //@ManyToOne significa que muchos objetos de la clase UsuarioRol pueden estar asociados con un solo objeto de la clase Usuario y un solo objeto de la clase Rol
